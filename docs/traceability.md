...
| 4. Window and platform behavior | [`product-experience.md`](./product-experience.md), [`architecture.md`](./architecture.md) | Window-state, geometry, accessibility, and platform checks |
...
| 8. Persistence, capture, and release constraints | [`architecture.md`](./architecture.md), [`release.md`](./release.md), [`testing.md`](./testing.md) | Persistence, capture-boundary, packaging, and platform reports |
